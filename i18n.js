(() => {
  ...
  const I18N = {
    ru: {
      ...
      browserProfileAuto: 'Авто (определять автоматически)',
      browserProfileChrome: 'Chrome/Chromium',
      browserProfileFirefox: 'Firefox',
      browserProfileSafari: 'Safari',
      browserProfileHintAuto: 'Авто определяет движок браузера: {browser}. Можно выбрать вручную, если нужно.',
      browserProfileHintManual: 'Выбран профиль: {browser}. Если возникают проблемы, переключите на «Авто».',
      browserProfileHintChrome: 'Chrome/Chromium: максимальная визуальная плавность и полные эффекты.',
      browserProfileHintFirefox: 'Firefox: уменьшенные blur/эффекты для более стабильной отрисовки.',
      browserProfileHintSafari: 'Safari: облегченные эффекты и специальный режим открытия нескольких вкладок.',
      browserProfileLocalOnly: 'Профиль хранится только в этом браузере и не синхронизируется.',
      ...
      popupPermissionTitle: 'Разрешение на открытие вкладок',
      popupPermissionIntro: 'AirTab открывает сразу несколько вкладок, когда вы запускаете папку или выделенные ярлыки. Для этого браузеру нужно разрешить всплывающие окна для `airtabs.github.io`.',
      popupPermissionPrompt: 'Нажмите «Разрешить», чтобы проверить доступ сейчас.',
      popupPermissionBlocked: 'Popup-доступ пока заблокирован. Разрешите всплывающие окна для `airtabs.github.io` в настройках сайта и нажмите «Разрешить» снова.',
      popupPermissionGranted: 'Готово. Доступ к popup-вкладкам разрешён.',
      popupPermissionAllow: 'Разрешить',
      popupPermissionSkip: 'Не сейчас',
      ...
      fillEngineUrlField: 'Введите URL поисковика.',
      ...
      lazyGridLoadMore: 'Прокрутите вниз, чтобы загрузить ещё {count}',
      kagiSigninHint: 'Kagi может показать приветственную страницу, если вы не вошли в аккаунт Kagi. Это нормально: авторизуйтесь один раз, и дальше поиск будет открываться сразу.',
    ...
    en: {
      ...
      browserProfileAuto: 'Auto (detect automatically)',
      browserProfileChrome: 'Chrome/Chromium',
      browserProfileFirefox: 'Firefox',
      browserProfileSafari: 'Safari',
      browserProfileHintAuto: 'Auto detected browser engine: {browser}. You can switch manually if needed.',
      browserProfileHintManual: 'Selected profile: {browser}. If something behaves oddly, switch back to Auto.',
      browserProfileHintChrome: 'Chrome/Chromium: full visual effects and maximum smoothness.',
      browserProfileHintFirefox: 'Firefox: reduced blur/effects for steadier rendering.',
      browserProfileHintSafari: 'Safari: lighter effects and a safer multi-tab opening strategy.',
      browserProfileLocalOnly: 'This profile is stored only in this browser and is not synchronized.',
      ...
      popupPermissionTitle: 'Permission to open tabs',
      popupPermissionIntro: 'AirTab opens multiple tabs at once when you run a folder or selected shortcuts. For this, your browser needs popup permission for `airtabs.github.io`.',
      popupPermissionPrompt: 'Click "Allow" to test access now.',
      popupPermissionBlocked: 'Popup access is currently blocked. Allow popups for `airtabs.github.io` in site settings and click "Allow" again.',
      popupPermissionGranted: 'Done. Popup tab access is allowed.',
      popupPermissionAllow: 'Allow',
      popupPermissionSkip: 'Not now',
      ...
      fillEngineUrlField: 'Enter the search engine URL.',
      ...
      lazyGridLoadMore: 'Scroll down to load {count} more',
      kagiSigninHint: 'Kagi can show a welcome page when you are not signed in. This is expected: sign in once, and searches will open directly after that.',
  ...
  const RU_TO_KEY = {
    ...
    'Профиль браузера': 'browserProfile',
    'Авто (определять автоматически)': 'browserProfileAuto',
    'Авто определяет движок браузера и подбирает совместимое поведение.': 'browserProfileHintAuto',
    ...
    'Разрешение на открытие вкладок': 'popupPermissionTitle',
    'AirTab открывает сразу несколько вкладок, когда вы запускаете папку или выделенные ярлыки. Для этого браузеру нужно разрешить всплывающие окна для `airtabs.github.io`.': 'popupPermissionIntro',
    'Нажмите «Разрешить», чтобы проверить доступ сейчас.': 'popupPermissionPrompt',
    'Разрешить': 'popupPermissionAllow',
    'Не сейчас': 'popupPermissionSkip',
